...
cmd_handler_t proto_somfy_sub_cmd[] = {
   { &proto_somfy_help,   &proto_handler, NULL, "help", "this help", 0, "", "opensesame somfy help"},
...
cmd_handler_t proto_ev1527_sub_cmd[] = {
   { &proto_ev1527_help,   &proto_handler, NULL, "help", "this help", 0, "", "opensesame ev1527 help"},
